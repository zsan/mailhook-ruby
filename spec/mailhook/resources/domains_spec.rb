...
RSpec.describe Mailhook::Resources::Domains do
  ...
  describe "#list" do
    before do
      stub_request(:get, "https://app.mailhook.co/api/v1/domains")
        .to_return(
          status: 200,
  ...
  describe "#retrieve" do
    before do
      stub_request(:get, "https://app.mailhook.co/api/v1/domains/1")
        .to_return(
          status: 200,
  ...
  describe "#delete" do
    before do
      stub_request(:delete, "https://app.mailhook.co/api/v1/domains/1")
        .to_return(
          status: 200,
  ...
  describe "#check_slug" do
    before do
      stub_request(:get, "https://app.mailhook.co/api/v1/domains/check_slug")
