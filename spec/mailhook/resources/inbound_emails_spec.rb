...
RSpec.describe Mailhook::Resources::InboundEmails do
  ...
  describe "#list" do
    before do
      stub_request(:get, "https://api.mailhook.dev/api/v1/inbound_emails")
        .to_return(
          status: 200,
          body: {
            data: [
  ...
  describe "#retrieve" do
    before do
      stub_request(:get, "https://api.mailhook.dev/api/v1/inbound_emails/1")
        .to_return(
          status: 200,
          body: {
            id: "1",
  ...
  describe "#mark_read" do
    before do
      stub_request(:patch, "https://api.mailhook.dev/api/v1/inbound_emails/1/read")
        .to_return(
          status: 200,
  ...
  describe "#batch_mark_read" do
    before do
      stub_request(:patch, "https://api.mailhook.dev/api/v1/inbound_emails/batch/read")
  ...
  describe "error handling" do
    before do
      stub_request(:get, "https://api.mailhook.dev/api/v1/inbound_emails/999")
        .to_return(
          status: 404,
